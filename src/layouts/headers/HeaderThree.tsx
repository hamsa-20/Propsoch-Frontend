...
import logo_1 from "@/assets/images/logo/logo_06.png";
               ...
               <div className="top-header position-relative">
                  <div className="d-flex align-items-center">
                     ...
                     <div className="order-lg-2 d-none d-xxl-block">
                        <p className="m0 email-text ps-5 pe-5">Our Email <Link href="#" className="tran3s fw-500 ms-2">support@propsoch.com</Link></p>
                     </div>
