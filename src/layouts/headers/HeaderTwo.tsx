...
import logo_1 from "@/assets/images/logo/logo_02.png";
import logo_2 from "@/assets/images/logo/logo_04.png";
import logo_3 from "@/assets/images/logo/logo_06.png";
                           ...
                           {!style_2 ? (<><li className="d-flex align-items-center login-btn-one">
                              ...
                              <li className="d-none d-xl-block">
                                 ...
                                 <li className="d-none d-md-flex align-items-center login-btn-one me-4 me-xxl-5">
                                    ...
                                    <Link href="tel:+080-0000-0000" className="tran3s">+910-0000-0000</Link>
                                 </li>
                                 <li>
