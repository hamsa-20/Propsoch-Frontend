...
import footerLogo from "@/assets/images/logo/logo_07.png"
                     ...
                     <div className="col-lg-6">
                        <div className="text-center text-lg-start md-mb-40">
                           ...
                           <p className="fs-24 text-white opacity-75 m0">
                              Get practical insights on Bangalore real estate, prices & risks
                           </p>
                        </div>
                     </div>
                     <div className="col-lg-6">
                        <div className="form-wrapper me-auto ms-auto me-lg-0">
                           <form onSubmit={(e) => e.preventDefault()}>
                              <input type="email" placeholder="Enter your email address" className="rounded-0" />
                              <button className="rounded-0">Subscribe</button>
                           </form>
                           <div className="fs-16 mt-10 text-white">
                              <span className="fw-light opacity-75">Already a member?</span>{" "}
         ...
         <div className="container container-large">
                  ...
                  <div className="col-xl-3 col-lg-4 mb-60">
                     <div className="footer-intro">
                        <div className="logo mb-20">
                           <Link href="/">
                              <Image src={footerLogo} alt="PropSoch Logo" />
                           </Link>
                        </div>
            ...
            <div className="bottom-footer">
               <p className="m0 text-center fs-16">
                  © 2026 Thinkr Proptech Pvt. Ltd. All rights reserved.
               </p>
            </div>
         </div>
      </div>
