...
import footerLogo_1 from "@/assets/images/logo/logo_05.png"
...
const footer_content: ContentType = {
   title: "Stay Updated",
   desc_1: "Get practical insights and verified updates on Bangalore real estate",
   desc_2: "Bengaluru, Karnataka, India",
   email: "hello@propsoch.com",
                  ...
                  <div className="col-xl-3">
                     <div className="footer-intro position-relative z-1 pt-70 pb-150 lg-pb-20">
                        <div className="logo mb-15">
                           <Link href="/">
                              <Image src={footerLogo_1} alt="PropSoch Logo" />
                           </Link>
                        </div>
