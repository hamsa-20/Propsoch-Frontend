...
<blockquote className="font-garamond text-white">
  &quot;Outstanding <span>service!</span> Smooth process, clear guidance, and quick turnaround. Truly reliable.&quot;
</blockquote>
                        <div className="d-flex align-items-center mt-75 md-mt-60">
                           <Image src={feedbackAvatar} alt="" className="rounded-circle avatar" />
                           <div className="ps-4">
                              <h6 className="fs-22 text-white fw-normal mb-5">Rahul Mehta.</h6>
                              <span className="text-white opacity-50 fw-light">Managing Partner, Propsoch Realty</span>
                           </div>
                        </div>
                     </div>
                  </div>
