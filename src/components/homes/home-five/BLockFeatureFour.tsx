               ...
               <div className="col-lg-6 ms-auto order-lg-last wow fadeInRight">
                  <div className="pb-50 ps-xxl-5 position-relative z-1">
                     <div className="feedback-block-two">
                        <blockquote className="font-garamond">
                           &quot;Exceptional <span>experience!</span> Seamless property deals and transparent support throughout.&quot;
                        </blockquote>
                        <div className="d-flex align-items-center mt-75 md-mt-50">
                           <Image src={featureImg_1} alt="" className="rounded-circle avatar" />
                           <div className="ps-4">
                              <h6 className="fs-22 mb-5">Rohan Mehta</h6>
                              <span className="opacity-75">Founder & Managing Director</span>
                           </div>
                        </div>
                     </div>
                           ...
                           <div className="col-sm-6">
                              <div className="counter-block-two dark mt-30">
                                 <div className="main-count sm font-garamond fw-500">
                                    <span className="counter"><Count number={2500} /></span>+
                                 </div>
                                 <p className="fs-20 m0">Properties Delivered</p>
                              </div>
                           </div>
                           <div className="col-sm-6">
                              <div className="counter-block-two dark mt-30">
                                 <div className="main-count sm font-garamond fw-500">
                                    <span className="counter"><Count number={3.2} /></span>mil+
                                 </div>
                                 <p className="fs-20 m0">Satisfied Clients</p>
                              </div>
                           </div>
                        </div>
                     </div>
