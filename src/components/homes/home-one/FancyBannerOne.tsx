...
const FancyBannerOne = ({ style }: any) => {
  ...
  Exclusive <span>
    Monthly {style ? "" : <Image src={titleShape} alt="" className="lazy-img" />}
  </span>{" "}
  property deals for you.
</h3>
                     <p className="fs-24 text-white pe-xl-5 me-xxl-5">
  Discover handpicked properties and special offers curated by Propscoch experts.
</p>
                  </div>
...
<div className="tag mb-20">FOR SALE</div>
...
<h2 className="price text-center">
  ₹2,81,00,000
                     ...
                     <div className="button-group gutter d-flex justify-content-between align-items-center">
                        <Link href="/listing_details_02" className="btn-three"><span>View Full Details</span></Link>
