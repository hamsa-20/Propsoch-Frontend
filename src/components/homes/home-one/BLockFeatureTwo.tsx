                  ...
                  <div className="col-xxl-7 col-md-6 d-flex wow fadeInLeft">
                     <div className="block-one w-100 h-100">
                        <div className="position-relative z-1 h-100">
                           <h3 className="mb-55">
  Secure your family’s perfect home.
</h3>
                           ...
                           <div className="card-box text-center">
                              ...
                              <p className="fs-20">
  Years of experience <br /> you can trust.
</p>
...
<p className="fs-22 mt-20">
  Propscoch is your trusted real estate partner, helping you buy, sell,
  and rent properties with confidence across India.
</p>
...
<ul className="list-style-one fs-22 color-dark style-none">
  <li>Verified properties with transparent pricing</li>
  <li>100,000+ listings updated regularly</li>
  <li>Expert local agent consultation</li>
</ul>
