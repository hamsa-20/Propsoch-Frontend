...
const feedback_data: DataType[] = [
  {
    id: 1,
    blockquote: (
      <>Quick solutions coupled with extraordinary <span>performance</span>. The entire process was smooth and stress-free.</>
    ),
    name: "Amit Kulkarni",
  ...
  },
  {
    id: 2,
    blockquote: (
      <>Found our dream home with great <span>professional support</span>. Transparent process and excellent coordination.</>
    ),
  ...
  },
  {
    id: 3,
    blockquote: (
      <>Efficient and friendly service that guided us <span>perfectly</span> from start to finish. Highly satisfied.</>
    ),
    name: "Rohit Mehta",
