            ...
            <div className="row">
               <div className="col-lg-5">
                  <div className="title-one md-mb-40">
                     <h3>100+ <span>Companies <Image src={featureImg} alt="" className="lazy-img" /></span>Trust by us.</h3>
                  </div>
               </div>
               <div className="col-xxl-6 col-lg-7 ms-auto">
                  <p className="fs-24 lh-lg mb-30 color-dark">Your leading real estate advocate, transforming houses into dreams. Trust us to expertly guide you home.  500+ apartments & home for sell, rent & mortgage.</p>
