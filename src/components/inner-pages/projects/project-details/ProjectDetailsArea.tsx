...
const content_data: ContentType = {
  title_1: "Premium Apartments in Bangalore.",
  title_2: "Project Details",
  desc_1:
    "Your trusted real estate partner, helping you find the right home with confidence and clarity.",
  desc_2:
    "We specialize in premium apartments and residential projects across Bangalore and Mumbai, offering properties for buying, renting, and long-term investment.",
  project_details: [
    {
      count: "01",
      icon: projectDetailsIcon_1,
      title: "Launch Date",
      desc: "Sunday, 23 July, 2023",
    },
    {
      count: "02",
      icon: projectDetailsIcon_2,
      title: "Client Name",
      desc: "Propscoch Realty, Bangalore",
    },
    {
      count: "03",
      icon: projectDetailsIcon_3,
      title: "Project Type",
      desc: "Residential Apartments",
    },
  ],
};
