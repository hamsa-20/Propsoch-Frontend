...
const agency_details_content: ContentType = {
  title_1: "Propsoch Realty",
  title_2: "Arjun Malhotra",
  desc_1: "Indiranagar, Bengaluru",
  desc_4: "Real Estate Consultant",

  table_data: [
    { table_td_1: "Location", table_td_2: "Bengaluru, Karnataka, India" },
    { table_td_1: "Phone", table_td_2: "+91 98765 43210" },
    { table_td_1: "Email", table_td_2: "contact@propsoch.com" },
    { table_td_1: "Website", table_td_2: "www.propsoch.com" },
  ],

  table_data_2: [
    { table_td_1: "Location", table_td_2: "Mumbai, Maharashtra, India" },
    { table_td_1: "Phone", table_td_2: "+91 91234 56789" },
    { table_td_1: "Email", table_td_2: "mumbai@propsoch.com" },
    { table_td_1: "Experience", table_td_2: "8+ Years" },
  ],

  icon: ["whatsapp", "instagram", "x-twitter"],

  desc_2: (
    <>
      Before joining Propsoch, Arjun worked with leading residential and
      commercial real estate firms in Bengaluru, helping families and
      investors find the right properties with transparency and trust.
    </>
  ),

  desc_3: (
    <>
      Our approach focuses on data-driven insights, legal clarity, and
      customer-first service, ensuring smooth transactions and long-term
      value for buyers, sellers, and investors across Mumbai and Bengaluru.
    </>
  ),
};
