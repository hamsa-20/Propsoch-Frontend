...
const review_data: DataType[] = [
  {
    ...
    desc: (
      <>
        Smooth experience from property shortlisting to final paperwork.
        The team clearly understands the Bangalore real estate market.
      </>
    ),
  },
  {
    ...
    rating: ["star", "star", "star", "star", "star"],
    img_slider: [
      { img_id: "4", img: agencyDetailsImg_4 },
      { img_id: "5", img: agencyDetailsImg_5 },
      { img_id: "6", img: agencyDetailsImg_6 },
    ],
    desc: (
      <>
        Found a great apartment in Andheri within our budget.
        Very transparent process and excellent coordination throughout.
      </>
    ),
  },
  {
    ...
    desc: (
      <>
        Helpful guidance while renting a flat in Whitefield.
        Documentation and follow-ups were handled professionally.
      </>
    ),
  },
];
